/**
 * Scraper for Carson City Assessor data.
 *
 * Carson City uses DevNet Wedge platform at carsoncitynv.devnetwedge.com
 * This scraper uses the DataTables server-side API to efficiently fetch
 * parcels by year built range.
 *
 * Usage: pnpm --filter fieldline scrape:carson-assessor
 */
...
const BASE_URL = 'https://carsoncitynv.devnetwedge.com';
...
async function main() {
  console.log('Carson City Assessor Scraper');
  console.log('============================\n');
