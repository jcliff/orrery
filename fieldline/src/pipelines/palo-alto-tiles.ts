...
const INPUT = join(__dirname, '../../data/processed/palo-alto/parcels-detailed.geojson');
// Output: PMTiles file for palo-alto project
const OUTPUT_DIR = join(__dirname, '../../../projects/palo-alto/public');
