...
export const easternCensusConfig: VisualizationConfig = {
  id: 'eastern-census',
  name: 'Eastern Census History',

  // Center to show Original 13 Colonies
  center: [-77, 38],
  zoom: 5,
  ...
  sources: [
    {
      id: 'eastern-counties',
      type: 'geojson',
      url: '/data/nhgis-eastern/counties.geojson',
    },
  ],
  ...
  layers: [
    // County fill layer
    {
      id: 'eastern-counties-fill',
      sourceId: 'eastern-counties',
      type: 'fill',
      paint: {
  ...
  legend: {
    ...
    items: [
      { label: '<10/sq mi', color: '#f7fbff', shape: 'square' },
      { label: '10-50/sq mi', color: '#c6dbef', shape: 'square' },
      { label: '50-100/sq mi', color: '#6baed6', shape: 'square' },
      { label: '100-250/sq mi', color: '#4292c6', shape: 'square' },
      { label: '250-500/sq mi', color: '#2171b5', shape: 'square' },
  ...
  defaultYearRange: [1790, 2020],

  title: {
    text: 'Eastern US Census History (1870-2020)',
    countProperty: 'gisjoin',
    countLabel: 'counties',
  },

  popup: {
    layers: ['eastern-counties-fill'],
    render: (props) => {
